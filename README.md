...
- <ins> **(IMPORTANT)** **Please input a music artist of your choice when running this. Put the artist name in quotes.**  **For example**: python artist_personality.py “Drake” </ins>
